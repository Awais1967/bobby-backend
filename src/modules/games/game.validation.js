...
const baseGameFields = {
  ...
  totalPayment: Joi.number().min(0).default(0),
  fullServicePayment: Joi.number().min(0).default(0),
  quickServicePrice: Joi.number().min(0).default(0),
...
const updateGameValidation = Joi.object({
  ...
  totalPayment: Joi.number().min(0).optional(),
  fullServicePayment: Joi.number().min(0).optional(),
  quickServicePrice: Joi.number().min(0).optional(),
